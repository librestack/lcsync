...
const int waits = 3;
const int waits_valgrind = 10; // high for valgrind
...
int main(void)
{
	char src[] = "0000-0074.src.tmp.XXXXXX";
	char dst[] = "0000-0074.dst.tmp.XXXXXX";
	int rc = 0;

	loginit();
	test_name("net_send() / net_sync() - zero length file");
